    ...
    <body>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                setInterval(loadStudentNotifications, 120000);
                // Juga refresh saat dropdown dibuka
                $('#studentNotificationsDropdown').on('show.bs.dropdown', function () {
                    loadStudentNotifications();
                });
                @endif
            });
