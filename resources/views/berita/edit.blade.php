    ...
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted">Edit berita atau informasi</p>
                    </div>
                    <div>
                        <a href="{{ route('berita.show', $berita) }}" class="btn btn-secondary">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('berita.update', $berita) }}" method="POST" enctype="multipart/form-data" id="formBerita">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                @error('gambar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div id="imagePreview" class="mt-2 {{ $berita->gambar ? '' : 'd-none' }}">
                                    <img src="{{ $berita->gambar ? asset('storage/'.$berita->gambar) : '' }}" 
                                         alt="Preview" 
                                         class="img-thumbnail" 
            ...
            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('is_published') is-invalid @enderror" 
                                    id="is_published" 
                                    name="is_published">
                                <option value="0" {{ old('is_published', $berita->is_published) == '0' ? 'selected' : '' }}>Draft</option>
                                <option value="1" {{ old('is_published', $berita->is_published) == '1' ? 'selected' : '' }}>Publikasikan</option>
                            </select>
                            @error('is_published')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('berita.show', $berita) }}" class="btn btn-outline-secondary">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <small class="text-muted">Dipublikasikan pada:</small>
                            <div>{{ $berita->published_at->format('d/m/Y H:i') }}</div>
                        </div>
                        @endif
                    </div>
                </div>
