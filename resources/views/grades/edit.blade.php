        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="fw-bold">Edit Penilaian</h2>
                        <p class="text-muted">Edit penilaian mahasiswa {{ $grade->user->name }}</p>
                    </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Form Edit Penilaian</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('grades.update', $grade) }}" method="POST">
                                        ...
                                        <select class="form-select @error('user_id') is-invalid @enderror" 
                                            ...
                                            @foreach($students as $student)
                                                <option value="{{ $student->id }}" 
                                                        {{ old('user_id', $grade->user_id) == $student->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_kehadiran_pembekalan') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('nilai_kehadiran_pembekalan', $grade->nilai_kehadiran_pembekalan) }}" required>
                                                <div class="form-text">Bobot: 5%</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_sikap_pembekalan') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_sikap_pembekalan', $grade->nilai_sikap_pembekalan) }}" required>
                                                <div class="form-text">Bobot: 5%</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_kehadiran_lokasi') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_kehadiran_lokasi', $grade->nilai_kehadiran_lokasi) }}" required>
                                                <div class="form-text">Bobot: 5%</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_sikap_pelaksanaan') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_sikap_pelaksanaan', $grade->nilai_sikap_pelaksanaan) }}" required>
                                                <div class="form-text">Bobot: 5%</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_keterlibatan_kegiatan') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_keterlibatan_kegiatan', $grade->nilai_keterlibatan_kegiatan) }}" required>
                                                <div class="form-text">Bobot: 15%</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_relevansi_program') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_relevansi_program', $grade->nilai_relevansi_program) }}" required>
                                                <div class="form-text">Bobot: 15%</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_keberhasilan_program') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_keberhasilan_program', $grade->nilai_keberhasilan_program) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_sistematika_laporan') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_sistematika_laporan', $grade->nilai_sistematika_laporan) }}" required>
                                                <div class="form-text">Bobot: 3%</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_konten_medsos') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_konten_medsos', $grade->nilai_konten_medsos) }}" required>
                                                <div class="form-text">Bobot: 7%</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_bahasa') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_bahasa', $grade->nilai_bahasa) }}" required>
                                                <div class="form-text">Bobot: 2%</div>
                                                @error('nilai_bahasa')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_analisis') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_analisis', $grade->nilai_analisis) }}" required>
                                                <div class="form-text">Bobot: 3%</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_ketepatan_waktu') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_ketepatan_waktu', $grade->nilai_ketepatan_waktu) }}" required>
                                                <div class="form-text">Bobot: 5%</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('nilai_produk_teknologi') is-invalid @enderror" 
                                                       ...
                                                       min="0" max="100" step="0.01" 
                                                       value="{{ old('nilai_produk_teknologi', $grade->nilai_produk_teknologi) }}" required>
                                                <div class="form-text">Bobot: 10%</div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('catatan') is-invalid @enderror" 
                                          ...
                                          placeholder="Catatan tambahan untuk mahasiswa...">{{ old('catatan', $grade->catatan) }}</textarea>
                                @error('catatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <h3 class="text-primary" id="nilai_akhir">{{ number_format($grade->nilai_akhir, 1) }}</h3>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Grade</label>
                            <h4 class="text-success" id="grade">{{ $grade->grade }}</h4>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Status</label>
                            <span class="badge {{ $grade->nilai_akhir >= 60 ? 'bg-success' : 'bg-danger' }}" id="status">
                                {{ $grade->nilai_akhir >= 60 ? 'Lulus' : 'Tidak Lulus' }}
                            </span>
                        </div>
