...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configuration for file uploads including maximum file size and timeout
    | settings.
    |
    */

    'upload' => [
        'max_file_size' => env('UPLOAD_MAX_FILE_SIZE', 20971520), // 20MB in bytes
        'max_post_size' => env('UPLOAD_MAX_POST_SIZE', 26214400), // 25MB in bytes
